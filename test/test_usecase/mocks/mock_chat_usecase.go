...
func (m *MockChatUsecase) CreateChat(ctx context.Context, SenderID primitive.ObjectID, ReceiverID primitive.ObjectID) (primitive.ObjectID, error) {
...
func (m *MockChatUsecase) GetChatByParticipants(ctx context.Context, SenderID primitive.ObjectID, ReceiverID primitive.ObjectID) (*domain.Chat, error) {
	args := m.Called(ctx, SenderID, ReceiverID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
